...
export default async function Home() {
  ...
  const stats: {
    ...
    },
    {
      ...
      content: event.chip_plays[0].num_played.toLocaleString() || 'N/A',
    },
    {
      id: 'freehit_played',
      title: 'Free Hit Played',
      content: event.chip_plays[1].num_played.toLocaleString()  || 'N/A',
    },
    {
      id: 'wildcard_played',
      title: 'Wildcards Played',
      content: event.chip_plays[2].num_played.toLocaleString() || 'N/A',
    },
    {
      id: '3xc_played',
      title: 'Tripe Captain Played',
      content: event.chip_plays[3].num_played.toLocaleString() || 'N/A',
    },
  ];
